System.register(["imgui-js", "./imgui_impl.js", "./imgui_demo.js", "./imgui_memory_editor.js"], function (exports_1, context_1) {
    ...
    function _init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // T: for now this code is useless (START)
            // StartUpImage();
            // StartUpVideo();
            // T: for now this code is useless (END)
    ...
    function _loop(time) {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
        {
            ...
            // T: NOTES: this code for now is useless (START)
            // T: WARNING: must review what i commented
            ...
            //     ImGui.PopFont();
            // }
            // T: NOTES: this code for now is useless (END)
        ...
        // T: NOTES: for now this code is useless (START)
        // T: NOTES: code for the "another_window"
